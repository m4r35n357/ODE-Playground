...
Arbitrary-precision solver and models now using GNU bc (in preference to MPFR in master branch).
Updated 'ode-playground' script
Animated ODE plots added from Python branch (using Python/Matplotlib)
